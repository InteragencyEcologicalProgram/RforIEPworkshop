...
Using a project in RStuio will set your working directory so you don't have to do it at the top of each script.


# Functions

R uses functions for most of its data analysis and manipulation methods. Becoming comfortable with the syntax of these functions is super important. RStuduio makes this easier!

Each function requires certain arguments be passed to the fuction, and will give you certain values. 
...
Notice that when you start typing, RStuio has a drop down that suggests what you might be looking for.

The function 'mean' only requires one argument. 'x' which will usually be a vector of nubers.

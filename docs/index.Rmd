...
Required software: R, Rstudio, Rtools and the following packages: LIST PACKAGES HERE!
...
Required software: R, Rstudio, Rtools and the following packages: tidyverse, hms, readxl, lubridate
...
Required Software: R, Rstudio, and the following packages: LIST PACKAGES HERE

Plotting multiple graphs at once, different plot sizes using Layout, displaying multiple variables on one plot, stacked area plots, plotting model outputs, graphing aesthetics.
